...
🚀 Quick Start (Installation & Run)Get the game running on your local machine in just a few steps.1. PrerequisitesMake sure you have a working webcam (built-in or external) and Python 3.7+ installed.2. Setup the EnvironmentIt's highly recommended to use a virtual environment.Bash# 1. Clone the repository (once uploaded to GitHub)
